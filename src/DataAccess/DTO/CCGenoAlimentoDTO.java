...
public class CCGenoAlimentoDTO {
    ...
    public CCGenoAlimentoDTO() {}

    public CCGenoAlimentoDTO(String nombreGenoAlimento) {
        this.NombreGenoAlimento = nombreGenoAlimento;
    }

    public CCGenoAlimentoDTO(Integer codigoGenoAlimento, String nombreGenoAlimento, String estado, String fechaCrea, String fechaModifica) {
